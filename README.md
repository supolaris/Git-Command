...
| `git clone ssh://git@github.com/[username]/[repository-name].git` | Create/Clone a git repository using SSH |
| `git clone https://github.com/[username]/[repository-name].git` | Create/Clone a git repository using HTTPS |
